...
const Display = () => {
  return (
    ...
    <div className='w-full h-full  flex bg-black'>
        <div className='w-4/12  text-center items-center justify-center flex' ><p className='bg-gradient-to-br from-red-600 to-pink-500 text-transparent bg-clip-text  font-shadows-into-light text-5xl font-semibold  '>Shopping    Simplified, Satisfaction Guaranteed</p>
</div>
    ...
    <div className='flex w-4/12 items-center justify-between ml-14  '>
        ...
        <div className='relative  pt-12 rounded-t-full bg-white pb-4 m-4 '>
            ...
            <button className='bg-red-800 text-white rounded-3xl px-4 py-2 absolute left-[18%]'>Shop now</button>
        </div>
